...
public class UserModel implements Serializable{
	...
	public UserModel(int id, String username, String password, String images, String fullname, String email,
			String phone, int releid, Date createDate, int roleid) {
		super();
		this.id = id;
	...
	public UserModel(int int1, String string, String string2, String string3, String string4, String string5, int int2,
