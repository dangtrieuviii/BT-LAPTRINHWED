...
public class CategoryController {
	...
	{
		List<java.util.Locale.Category> list = null;
		try {
	...
	public ModelAndView edit (ModelMap model,@PathVariable("id") Long categoryId) {
		Optional<java.util.Locale.Category> optCategory =categoryService.findById(categoryId);
		CategoryModel cateModel = new CategoryModel();
		
		if (optCategory.isPresent()) {
			java.util.Locale.Category entity =(java.util.Locale.Category) optCategory.get();
